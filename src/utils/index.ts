...
export const componentNames: ComponentName[] = [ 'avatar', 'button', 'card', 'checkbox', 'chip', 'date-picker', 'dialog', 'divider', 'empty', 'footer', 'form', 'icon', 'list', 'modal', 'overlay', 'panel-group', 'panel', 'progress', 'spoiler' ]
